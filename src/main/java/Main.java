...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        final String token = "Nzk0MjEyNzM1MTE4MDgyMDY5.X-3iPw.9l5yfMccg6P0YEloDMwxNZ3pRKo";  //Aqui tendriamos nuestro token. Dicho token se saca creando una aplicación en la página de Developer de Discord.
                                                                                            // Dicha aplicación te permitira crear el bot en ella.
